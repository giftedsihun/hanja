...
if df_all.empty:
    ...
    if df.empty:
        ...
        if menu_choice == "단어집 목록":
            ...
            # 따옴표 충돌 없이 f-string 사용
            st.markdown(
                f"<div style='text-align: center; font-size: 120px; margin: 20px;'>{current_hanja['hanja']}</div>",
            ...
            if st.session_state.options:
                ...
                st.markdown(
                    f"<h2 style='text-align: center; margin: 20px;'>{current_hanja['meaning']} {current_hanja['sound']}</h2>",
                    unsafe_allow_html=True
                )
